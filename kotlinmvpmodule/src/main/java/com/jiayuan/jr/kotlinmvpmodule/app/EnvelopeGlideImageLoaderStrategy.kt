 ...
 * Description :
 */
class EnvelopeGlideImageLoaderStrategy : BaseImageLoaderStrategy<EnvelopeImageConfig>, GlideAppliesOptions {

    override fun loadImage(ctx: Context?, config: EnvelopeImageConfig?) {
    ...
    override fun clear(ctx: Context?, config: EnvelopeImageConfig?) {
        if (ctx == null) throw NullPointerException("Context is required")
        if (config == null) throw NullPointerException("ImageConfigImpl is required")
